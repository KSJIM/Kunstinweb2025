...
sections: [
  {
    ...
    'Munas': {
      ...
      info: [
        ...
        { label: 'Role', value: 'Designer / Fabricator, In collab with Lilian Ma' },
        { label: 'Year', value: '2025' },
        { label: 'Advisor', value: 'Mike Rivera' },
            { label: 'Introduction', value: <p className="tight-value">
     Drawing from the structural language of classical architecture, this project explores the idea of wearable architecture through 3D printing on fabric.
      </p> }
],
